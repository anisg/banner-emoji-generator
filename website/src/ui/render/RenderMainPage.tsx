import React from 'react';
  import {cls, DivProps, Div, Span, SpanProps, ImgProps} from './lib';
    
  export type MainPageProps = {
    frames:{["Frame 1"]: DivProps;
["Frame 7"]: DivProps;
["Banner emoji generator"]: SpanProps;
["The service allows you to generate an emoji banner image. Ideal to prettify your tasks in Notion. Change the emoji by clicking on it."]: SpanProps;
["Frame 6"]: DivProps;
["Frame 4"]: DivProps;
["Ellipse 1"]: SvgProps;
["icon_icon"]: SvgProps;
["Ellipse 3 (Stroke)"]: SvgProps;
["Vector 2"]: SvgProps;
["Ellipse 3.2"]: SvgProps;
["Ellipse 3.1"]: SvgProps;
["Frame 5"]: DivProps;
["Frame 3"]: DivProps;
["Notion cover format"]: SpanProps;
["Vector 1"]: SvgProps;
["Frame 2"]: DivProps;
["Download image"]: SpanProps;
...
["Ellipse 44"]: SvgProps;
["Ellipse 43"]: SvgProps;
["Ellipse 45 (Stroke)"]: SvgProps;
["LiveDesign"]: SpanProps}
  }
  
  export const MainPage = function(props:MainPageProps){
    return (
        <div className={cls(frames,"mainPage", ` gap-[30px] flex-row w-fit items-start overflow-hidden relative bg-[#e9ecf1] opacity-100 p-[85px] flex`)}>
  <div className={cls(frames,"frame1", ` gap-[23px] flex-col items-center shrink-0 overflow-hidden relative border shadow-[0px_4px_4px_rgba(0,0,0,0.05000000074505806)] bg-white opacity-100 pt-[25px] pb-[17px] px-[21px] rounded-xl border-[#ebebeb] flex`)}>
    <div className={cls(frames,"frame7", ` gap-2 flex-col shrink-0 self-stretch object-cover relative opacity-100 p-0 flex"><span className="bannerEmojiGenerator font-['Roobert'] text-lg font-bold text-[#2f3136] text-left flex flex-row justify-start shrink-0 relative`)}>Banner emoji generator</span>
